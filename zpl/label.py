...
class Label:
    ...
    def preview(self, index=0):
        ...
        try:
            ...
            raise Exception(
                "Invalid preview received, mostlikely bad ZPL2 code uploaded."
            )
...
def __main__():
    ...
    l.origin(0, 0)
    l.write_text(
        "Problem?", char_height=10, char_width=8, line_width=60, justification="C"
    )
    l.endorigin()
